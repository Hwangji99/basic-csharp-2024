...
{   
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            notifier.EventOccured("메일을 받았어요!!"); // 1, 2, 3번 실행
            Console.WriteLine();

            notifier.EventOccured -= listener2.SomethingHappened; // 리스너2번의 함수는 실행하지마라
            notifier.EventOccured("파일 다운로드 완료!!!"); // 1, 3번 실행
            Console.WriteLine();
            ...
            Console.WriteLine(); // 원폼(PyQt 등) 이벤트도 이와 유사한 형태로 동작
